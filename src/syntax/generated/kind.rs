...
impl std::fmt::Display for SyntaxKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            SyntaxKind::IntType => write!(f, "{}", "int"),
            SyntaxKind::FloatType => write!(f, "{}", "float"),
            SyntaxKind::BoolType => write!(f, "{}", "bool"),
            SyntaxKind::CharType => write!(f, "{}", "char"),
            SyntaxKind::StringType => write!(f, "{}", "string"),
            ...
            SyntaxKind::Function => write!(f, "{}", stringify!(Function)),
            SyntaxKind::StructBody => write!(f, "{}", stringify!(StructBody)),
